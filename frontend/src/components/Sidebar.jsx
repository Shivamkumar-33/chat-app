        ...
        {filteredUsers.map((user) => (
          ...
          >
            <div className="relative mx-auto lg:mx-0">
              ...
              {user.unreadCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-primary text-primary-content text-xs rounded-full size-5 flex items-center justify-center font-bold lg:hidden">
            ...
            {/* Unread count badge */}
            {user.unreadCount > 0 && (
              <div className="badge badge-primary badge-sm hidden lg:flex">
